                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="nama" required autofocus
                                placeholder="Masukkan Nama..." value="{{ old('nama', $user->nama) }} " oninput="this.value = this.value.replace(/[^a-z A-Z]/g, '')">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jabatan" value="Guru"
                                    checked>
