...
<header class="masthead text-center text-white">
    <div class="masthead-content">
        <div class="container px-5">
            ...
            <h2 class="masthead-subheading mb-0">SMP Negeri 3 Kota Bengkulu</h2>
        ...
        <div class="row gx-5 align-items-center">
            ...
            <div class="col-lg-6">
                <div class="p-5">
                    ...
                    <p>Klik di bawah ini untuk menuju laman Tentang Perpustakaan SMP Negeri 3 Kota Bengkulu.</p>
