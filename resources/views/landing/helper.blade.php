            ...
            <div class="accordion-item">
                ...
                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body text-start">
                        <p> 1. Pastikan Anda telah terdaftar sebagai anggota perpustakaan dengan menunjukkan kartu perpustakaan. </p>
                ...
                <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body text-start">
                        <p> Denda merupakan kebijakan perpustakaan yang diberikan kepada peminjam yang melakukan transaksi
                            ...
                            Denda akan dikenakan Rp1.000/hari keterlambatan. </p>
                    </div>
                </div>
            </div>
        </div>
